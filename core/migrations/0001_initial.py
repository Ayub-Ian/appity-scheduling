# Generated by Django 4.2.13 on 2024-07-07 11:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.BigIntegerField(default=core.utils.RandomId('core.AppUser'), primary_key=True, serialize=False, unique=True)),
            ...
            managers=[
                ('objects', core.models.AppityUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Client',
            fields=[
                ('id', models.BigIntegerField(default=core.utils.RandomId('core.Client'), primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access', models.CharField(choices=[(1, 'Public'), (0, 'Private')], default=1, max_length=50)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='client',
            name='currency',
            field=models.ForeignKey(default=core.models.get_default_currency, on_delete=django.db.models.deletion.CASCADE, to='core.currency'),
        ),
        migrations.AddField(
            model_name='client',
            name='users',
